...
export class CanExecuteTimeoutUpdated extends ethereum.Event {
  get params(): CanExecuteTimeoutUpdated__Params {
    return new CanExecuteTimeoutUpdated__Params(this);
  }
}

export class CanExecuteTimeoutUpdated__Params {
  _event: CanExecuteTimeoutUpdated;

  constructor(event: CanExecuteTimeoutUpdated) {
    this._event = event;
  }
...
export class DevGovFeeCharged extends ethereum.Event {
  get params(): DevGovFeeCharged__Params {
    return new DevGovFeeCharged__Params(this);
  }
}

export class DevGovFeeCharged__Params {
  _event: DevGovFeeCharged;

  constructor(event: DevGovFeeCharged) {
    this._event = event;
  }
...
export class NftBotFeeCharged extends ethereum.Event {
  get params(): NftBotFeeCharged__Params {
    return new NftBotFeeCharged__Params(this);
  }
}

export class NftBotFeeCharged__Params {
  _event: NftBotFeeCharged;

  constructor(event: NftBotFeeCharged) {
    this._event = event;
  }
...
export class GNSTradingCallbacksV6_4__tradeDataResult {
  value0: BigInt;
  value1: BigInt;
...
export class GNSTradingCallbacksV6_4__tradeLastUpdatedResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
  value3: BigInt;
...
export class GNSTradingCallbacksV6_4 extends ethereum.SmartContract {
  static bind(address: Address): GNSTradingCallbacksV6_4 {
    return new GNSTradingCallbacksV6_4("GNSTradingCallbacksV6_4", address);
  }
  ...
  tradeData(
    ...
    param2: BigInt,
    param3: i32
  ): GNSTradingCallbacksV6_4__tradeDataResult {
    let result = super.call(
      "tradeData",
    ...
    return new GNSTradingCallbacksV6_4__tradeDataResult(
      result[0].toBigInt(),
      result[1].toBigInt()
    );
  }
  ...
  try_tradeData(
    ...
    param2: BigInt,
    param3: i32
  ): ethereum.CallResult<GNSTradingCallbacksV6_4__tradeDataResult> {
    let result = super.tryCall(
      "tradeData",
      "tradeData(address,uint256,uint256,uint8):(uint40,uint216)",
      [
    ...
    return ethereum.CallResult.fromValue(
      new GNSTradingCallbacksV6_4__tradeDataResult(
        value[0].toBigInt(),
        value[1].toBigInt()
      )
    );
  ...
  tradeLastUpdated(
    ...
    param2: BigInt,
    param3: i32
  ): GNSTradingCallbacksV6_4__tradeLastUpdatedResult {
    let result = super.call(
      "tradeLastUpdated",
    ...
    return new GNSTradingCallbacksV6_4__tradeLastUpdatedResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt(),
      result[3].toBigInt()
  ...
  try_tradeLastUpdated(
    ...
    param2: BigInt,
    param3: i32
  ): ethereum.CallResult<GNSTradingCallbacksV6_4__tradeLastUpdatedResult> {
    let result = super.tryCall(
      "tradeLastUpdated",
      "tradeLastUpdated(address,uint256,uint256,uint8):(uint32,uint32,uint32,uint32)",
      [
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new GNSTradingCallbacksV6_4__tradeLastUpdatedResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
        value[2].toBigInt(),
        value[3].toBigInt()
...
export class SetCanExecuteTimeoutCall extends ethereum.Call {
  get inputs(): SetCanExecuteTimeoutCall__Inputs {
    return new SetCanExecuteTimeoutCall__Inputs(this);
  }

  get outputs(): SetCanExecuteTimeoutCall__Outputs {
    return new SetCanExecuteTimeoutCall__Outputs(this);
  }
}

export class SetCanExecuteTimeoutCall__Inputs {
  _call: SetCanExecuteTimeoutCall;

  constructor(call: SetCanExecuteTimeoutCall) {
    this._call = call;
  }
...
export class SetCanExecuteTimeoutCall__Outputs {
  _call: SetCanExecuteTimeoutCall;
